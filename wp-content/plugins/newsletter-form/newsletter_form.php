                            ...
                            <div class="left-content">
                                ...
                                <div class="versions_options">
                                    ...
                                    <div class="button_set_tabs_fp">
                                        <button class="form_version btn_tab tab_button <?php echo ( $cus_version == 'tab' )?'green':'gray'; ?>" value="tab_version" <?php echo ( $cus_version == 'tab' )?'disabled="disabled"':''; ?>>Place Across Your Site</button>
                                        <button class="form_version btn_tab custom <?php echo ( $cus_version == 'selectable' )?'green':'gray'; ?>" value="select_version" <?php echo ( $cus_version == 'selectable' )?'disabled="disabled"':''; ?> >Choose Pages</button>
